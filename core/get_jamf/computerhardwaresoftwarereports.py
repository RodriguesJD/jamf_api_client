...
class Computerhardwaresoftwarereports(GetJamf):

    url = '/computerhardwaresoftwarereports'
    ...
    def by_computerhardwaresoftwarereports_id_subset(self, id, start_date_end_date, subset):
        self.url = f"{self.url}/id/{id}/{start_date}_{end_date}/subset/{subset}"
        return self.get_jamf()
